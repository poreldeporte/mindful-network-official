	...
	return (
		<footer>
			...
			<p className="mx-auto max-w-3xl px-4 pb-4 text-center text-[11px] leading-relaxed text-gray-500 md:px-0">
				Provider information is subject to change. The Mindful Network does not
				endorse or guarantee the services of any listed provider. We encourage
				individuals to independently verify credentials, availability, insurance,
				and fit before engaging with any professional.
			</p>
