...
const PsychologistCard = ({
	...
	return (
		<li className="grid lg:grid-cols-[auto_1fr] w-full py-5 px-2.5 gap-5 items-center">
			<Image
			...
			<div className="flex flex-col">
				...
				<div className="grid lg:grid-cols-[1fr_auto] gap-2.5 mt-5">
					<div className="flex flex-col gap-1">
						<div>
					...
					<div className="flex items-end">
						<Link
							...
							className="px-3 py-1.5 rounded-full xs:w-full bg-blue-500 hover:bg-blue-700 transition-colors text-white text-center"
						>
