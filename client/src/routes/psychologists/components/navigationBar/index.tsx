...
export function NavigationBar() {
	...
	return (
		<nav className="hidden overflow-hidden lg:flex items-center justify-center fixed bottom-10 left-1/2 -translate-x-1/2 w-11/12 xl:w-3/4 max-w-[1440px] mx-auto z-10">
			<div className="bg-orange-100/60 backdrop-blur rounded-full px-10 py-5 flex items-center justify-between">
				...
				<Button className="p-2 rounded-full" variant="bodySmall">
					Get in Touch
				</Button>
			</div>
		</nav>
